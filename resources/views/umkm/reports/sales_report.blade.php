...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('reports.sales-report') }}" id="report-form">
                    <div class="row">
                        <div class="col-md-3">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <form action="{{ route('print.pdf.sales.report') }}" method="POST" target="_blank" class="d-inline">
                        @csrf
                ...
                @include('umkm.reports.partials.sales-report-tabel')
            </div>
