...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('reports.cash-inflows') }}" id="report-form">
                    <div class="row">
                        <div class="col-md-3">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="text-center w-100">
                    ...
                    <h5 class="mb-0">LAPORAN PENERIMAAN KAS</h5>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <form action="{{ route('print.pdf.cash.inflows') }}" method="POST" target="_blank" class="d-inline">
                        @csrf
                        <input type="hidden" name="month" value="{{ $month }}">
                        <input type="hidden" name="year" value="{{ $year }}">
                        <input type="hidden" name="totalCashInflow" value="{{ $totalCashInflow }}">
                        <input type="hidden" name="cashInflows" value="{{ json_encode($cashInflows) }}">
                ...
                @include('umkm.reports.partials.cash-inflows-tabel')
            </div>
