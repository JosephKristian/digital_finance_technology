@if (session('umkm_approve') == 1)
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#transaksiSideBar"
                aria-expanded="false" aria-controls="transaksiSideBar">
                <div class="sb-nav-link-icon"><i class="fas fa-handshake"></i></div>
                Transaksi
                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse" id="transaksiSideBar" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
            ...
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#accountingSideBar"
                aria-expanded="false" aria-controls="accountingSideBar">
            ...
            <div class="collapse" id="reportsSideBar" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
